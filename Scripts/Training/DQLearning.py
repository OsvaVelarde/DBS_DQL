...
FILES_PATH = '/mnt/BTE2b/DBS/Agosto-Diciembre-2019/DQLearning/TrainingFiles/'
OUTPUT_PATH = '/mnt/BTE2b/DBS/Agosto-Diciembre-2019/DQLearning/Trainings/'
DATE = str(date.today())
...
if __name__ == "__main__":
    ...
    num_episodes = 5              # Number of episodes 3000
    num_steps = 2                   # Number of actions to execute 50
    batch_size = 50                  
    ...
    g12,g13 = config_episode(g12_lims,g13_lims,num_episodes)

    # Parameters for simulations of BGTC network. --------------------------
    dt = 0.05               # [ms] - Time resolution
    fs = 1000/dt            # [Hz] - Sampling frequency
    tf = 5000 #10000              # [ms] - Generate the simulation in time (t0,t0 + tf)
    dt_transitory = 2500#7500    # [ms] - Delete the transitory interval (t0,t0 + dt_transitory)
    ...
    for ep in range(num_episodes):
        ...
        initial_conf_network[1,0]=g12[ep]
        initial_conf_network[2,0]=g13[ep]
        ...
        dbs_config = np.array([2, 0, 1, 0.5])                               # Amplitude DBS = 0 in N2.
        state = bgnet.solving_system(network,populations,dbs_config,t0,t1,dt_transitory,dt)[:,2] # Recording from N3
        ...
        for step in range(num_steps):
            ...
            t0 = t1
            t1 = t0 + tf
            next_state = bgnet.solving_system(network,populations,action,t0,t1,dt_transitory,dt)[:,2]
